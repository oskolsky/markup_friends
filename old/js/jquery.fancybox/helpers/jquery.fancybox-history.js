...
//			index = index > 0 ? index - 1 : 1;
	...
	beforeShow : function(opts, obj) {
		var gallery = $(obj.element).data('fancybox-group') || $(obj.element).attr('rel') || 'gallery';

		// Update window hash
		window.location.hash = this.current_hash = gallery + '-' + ($(obj.element).attr('id'));
